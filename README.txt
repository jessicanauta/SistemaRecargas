...
a persistence unit "SistemaRecargaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "SistemaRecarga\pom.xml":
...
artifact ("SistemaRecarga.war") is already built. You can build
